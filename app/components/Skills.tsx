  ...
  const skills = [
    {
      ...
      bgGradient:
        "from-blue-200 to-purple-100 dark:from-blue-900/90 dark:to-gray-900/90",
    },
    {
      ...
      bgGradient:
        "from-green-200 to-violet-50 dark:from-green-900/90 dark:to-gray-900/90",
    },
    {
      icon: <Server size={32} />,
      title: "Backend",
      ...
      bgGradient:
        "from-gray-100 to-gray-300 dark:from-gray-500/90 dark:to-gray-900/90",
    },
    {
      icon: <Users size={32} />,
      title: "Collaboration",
      ...
      bgGradient:
        "from-yellow-100 to-gray-100 dark:from-yellow-900/90 dark:to-gray-900/90",
    },
  ];
